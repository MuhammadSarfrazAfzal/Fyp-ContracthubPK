      ...
      <main className="dash-main">
        ...
        <div className="welcome-card">
          ...
          <div className="welcome-text">
            <h1 className="welcome-title">Welcome back, Client! 👋</h1>
        ...
        <div className="stats-grid">
          ...
          <div className="stat-card">
            ...
            <div className="stat-info">
              ...
              <p className="stat-value" style={{ color: '#22c55e', textTransform: 'capitalize' }}>{user?.role}</p>
            </div>
          </div>
        ...
        >
          ...
          <div style={{ flex: 1 }}>
            ...
            <p className="info-banner-text">
              Review and sign pending contracts for your active projects.
            </p>
          </div>
          <div style={{
        ...
        <div className="info-banner">
          <div className="info-banner-icon">🚀</div>
          <div>
            <h3 className="info-banner-title">Ready to start?</h3>
            <p className="info-banner-text">
              Invite freelancers to your workspace to begin collaborating on projects today.
            </p>
          </div>
        </div>
      </main>
